...
extern Memb_func* memb_func;
 ...
 "setdata_spike_rat", _hoc_setdata,
 "evaluate_fct_spike_rat", _hoc_evaluate_fct,
 "states_spike_rat", _hoc_states,
 0, 0
};
 ...
 "gnabar_spike_rat", "mho/cm2",
 "gkbar_spike_rat", "mho/cm2",
 "gabar_spike_rat", "mho/cm2",
 "gcabar_spike_rat", "mho/cm2",
 "gkcbar_spike_rat", "mho/cm2",
 "idrk_spike_rat", "mA/cm2",
 "iak_spike_rat", "mA/cm2",
 "icak_spike_rat", "mA/cm2",
 0,0
};
 static double c0 = 0;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 47, 11);
 	...
 	ivoc_help("help ?1 spike_rat C:/Users/Aruna/Documents/Medical_School/CC_Research/my_code/deus_ex_machina/5chan/temp/spike_rat.mod\n");
...
static int  evaluate_fct (  double _lv ) {
 ...
 _la = ( - 2.725 * ( _lv + 35.0 ) ) / ( ( exp ( - 0.1 * ( _lv + 35.0 ) ) ) - 1.0 ) ;
   _lb = 90.83 * ( exp ( ( - 1.0 * ( _lv + 60.0 ) ) / 20.0 ) ) ;
   tau_m = 1.0 / ( _la + _lb ) ;
   m_inf = _la * tau_m ;
...
static int _ode_count(int _type){ hoc_execerror("spike_rat", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 84 in file spike_rat.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
