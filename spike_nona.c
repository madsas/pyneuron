...
#define _ion_eca	*_ppvar[4]._pval
#define _ion_cao	*_ppvar[5]._pval
...
extern Memb_func* memb_func;
 ...
 "setdata_spike_nona", _hoc_setdata,
 "evaluate_fct_spike_nona", _hoc_evaluate_fct,
 "states_spike_nona", _hoc_states,
 0, 0
};
 ...
 "gkbar_spike_nona", "mho/cm2",
 "gabar_spike_nona", "mho/cm2",
 "gcabar_spike_nona", "mho/cm2",
 "gkcbar_spike_nona", "mho/cm2",
 "idrk_spike_nona", "mA/cm2",
 "iak_spike_nona", "mA/cm2",
 "icak_spike_nona", "mA/cm2",
 0,0
};
 static double c0 = 0;
...
static void nrn_alloc(Prop* _prop) {
 ...
 nrn_promote(prop_ion, 1, 1);
 	...
 	_ppvar[4]._pval = &prop_ion->param[0]; /* eca */
 	_ppvar[5]._pval = &prop_ion->param[2]; /* cao */
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 40, 8);
 	hoc_register_cvode(_mechtype, _ode_count, 0, 0, 0);
 	hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 spike_nona C:/Users/Aruna/Documents/Medical_School/CC_Research/my_code/deus_ex_machina/5chan/spike_nona.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("spike_nona", "cannot be used with CVODE"); return 0;}
 ...
 static void _update_ion_pointer(Datum* _ppvar) {
   ...
   nrn_update_ion_pointer(_ca_sym, _ppvar, 4, 0);
   nrn_update_ion_pointer(_ca_sym, _ppvar, 5, 2);
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 76 in file spike_nona.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
