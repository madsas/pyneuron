...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 13, 3);
 	...
 	ivoc_help("help ?1 na12 C:/Users/Aruna/Documents/Medical_School/CC_Research/my_code/deus_ex_machina/5chan/na12.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 86 in file na12.mod:\n        SOLVE states\n"); nrn_complain(_p); abort_run(error);}
