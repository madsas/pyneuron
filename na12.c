	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 3);
 	...
 	ivoc_help("help ?1 na12 /cygdrive/c/Users/Sasidhar/Desktop/CC_Research/my_code/deus_ex_machina/5chan/na12.mod\n");
...
static int _ode_count(_type)int _type; { hoc_execerror("na12", "cannot be used with CVODE");}
